...
export function VideoGrid({ local, remotes }: { local: {label:string;stream?:MediaStream;muted?:boolean} ; remotes: Array<{label:string;stream?:MediaStream;muted?:boolean}> }){
