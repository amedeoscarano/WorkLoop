    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2">
        <label className="inline-flex items-center gap-2 text-sm">
          ...
          Avvia con microfono disattivato
        </label>
        <label className="inline-flex items-center gap-2 text-sm">
          <input type="checkbox" checked={camOff} onChange={(e) => setCamOff(e.target.checked)} />{' '}
          Avvia con fotocamera spenta
        </label>
      </div>
        ...
        <button
          ...
          onClick={() =>
            onJoin({
              muted,
              camOff,
              deviceIds: { audio: audioId || undefined, video: videoId || undefined },
            })
          }
        >
          Entra
