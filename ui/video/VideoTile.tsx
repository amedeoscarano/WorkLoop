...
export function VideoTile({ label, stream, muted, speaking }: { label:string; stream?: MediaStream; muted?: boolean; speaking?: boolean }){
  ...
  return (
    <div className={`relative rounded-lg overflow-hidden bg-black ${speaking? 'ring-2 ring-blue-500' : ''}`}>
