  ...
  return (
    <aside className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4 w-full max-w-sm">
      <div className="flex items-center gap-3">
        ...
        <button className="ml-auto w-8 h-8 rounded-lg border border-slate-200 dark:border-slate-700">
          ⋯
        </button>
      </div>

      <button
        className="mt-3 w-full rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white py-2.5 text-sm font-medium"
