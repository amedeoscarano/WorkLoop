...
export function ScheduleModal({
  ...
  open: boolean
  onClose: () => void
  defaults?: { title?: string; duration?: number }
}) {
  ...
  return (
    ...
    >
      <div
        className="rounded-xl bg-white dark:bg-slate-900 p-4 w-[90%] max-w-md"
      ...
      >
        ...
        <div className="mt-4 flex justify-between">
          ...
          <div className="flex gap-2">
            ...
            <button className="px-3 py-2 rounded bg-blue-600 text-white" onClick={create}>
              Crea evento
            </button>
          </div>
        </div>
