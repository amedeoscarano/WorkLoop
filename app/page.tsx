    ...
    <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
      <div>
        ...
        <div className="mt-6 flex gap-3">
          ...
          <Link href="/login" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 dark:focus:ring-offset-slate-900">Accedi</Link>
        </div>
