      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-4">
        ...
        <div className="mt-3 grid md:grid-cols-2 gap-3">
          <Card title="Common Questions">
            <p className="text-sm text-slate-600">Get quick answers about sessions, scheduling and setup.</p>
          </Card>
          <Card title="Community Guidelines">
            <p className="text-sm text-slate-600">Learn how to show up respectfully and make the most of the community.</p>
          </Card>
        </div>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {['Getting Started','Help Center','Troubleshooting','Report a Bug','Contact Us'].map(x=> (
            <button key={x} className="px-2 py-1 rounded-lg border text-xs">{x}</button>
          ))}
        </div>
      </div>
    </DashboardShell>
