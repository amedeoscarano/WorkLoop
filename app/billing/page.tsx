  ...
  return (
    <section className="max-w-2xl">
      ...
      <p className="mt-2 text-slate-600 dark:text-slate-300">
        Sblocca stanze private e video (fase 2).
      </p>
      <div className="mt-4 rounded-xl border border-slate-200 dark:border-slate-800 p-4 flex items-center justify-between">
        ...
        <button
          ...
          className="px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
        >
          Upgrade
        </button>
      </div>
